...
Scope {
    ...
    // KDE port: Hyprland.focusedMonitor is not available on KDE Plasma.
    // Use Quickshell.screens[0] as primary screen fallback.
    property var focusedScreen: Quickshell.screens.length > 0 ? Quickshell.screens[0] : null
    ...
    Loader {
        ...
        sourceComponent: PanelWindow {
            ...
            // KDE port: anchor only bottom so OSD appears at the bottom of the screen.
            anchors {
                top: false
                bottom: true
                left: false
