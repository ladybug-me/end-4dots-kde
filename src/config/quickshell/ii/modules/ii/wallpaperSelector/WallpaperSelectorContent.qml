            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    GridView {
                        ...
                        // MEMORY: Only retain delegates within 3 rows above/below
                        // the visible viewport. Delegates outside this range are
                        // automatically destroyed and their Image memory freed.
                        // With cellHeight ~150px and 3 rows: ~450px buffer each side.
                        cacheBuffer: 0
