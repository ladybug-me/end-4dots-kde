            ...
            Item {
                ...
                Loader {
                    ...
                    sourceComponent: Image {
                        id: thumbnailImage
                        source: "file://" + fileModelData.filePath
                        cache: false           // MEMORY: don't retain in QML image cache
                        asynchronous: true     // MEMORY: decode off the main thread
                        // MEMORY: limit decoded texture to thumbnail dimensions.
                        // Full-res images are never decoded — only the thumbnail.
