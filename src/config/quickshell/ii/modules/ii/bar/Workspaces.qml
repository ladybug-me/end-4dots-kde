...
Item {
    ...
    function updateWorkspaceOccupied() {
        workspaceOccupied = Array.from({ length: root.workspacesShown }, (_, i) => true)
    }
    ...
    Grid {
        ...
        Repeater {
            ...
            Button {
                ...
                onPressed: Quickshell.execDetached(["qdbus6", "org.kde.KWin", "/KWin", "setCurrentDesktop", workspaceValue.toString()])
